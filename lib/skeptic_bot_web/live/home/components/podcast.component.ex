defmodule SkepticBotWeb.PodcastComponent do
  ...
  @spec podcast_video_card(map()) :: Phoenix.LiveView.Rendered.t()
  ...
  @spec podcast_video_card(map()) :: Phoenix.LiveView.Rendered.t()
  def podcast_video_grid_card(assigns) do
    ~H"""
  ...
  defp get_the_grid_vector_randomly(random) do
    assigns = %{}

    cond do
      random == 1 -> Component.absolute_grid_vectors_1(assigns)
      random == 2 -> Component.absolute_vectors_2(assigns)
      random == 3 -> Component.absolute_vectors_3(assigns)
    end
  end
