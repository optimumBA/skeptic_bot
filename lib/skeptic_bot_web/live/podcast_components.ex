defmodule SkepticBotWeb.PodcastComponents do
  ...
  def episode_card(assigns) do
    ~H"""
    <a
      href={episode_url(@episode.external_id, @timestamp, @episode.podcast.name)}
      class="flex flex-col gap-4 zoom-in-episode hover:font-[500]"
    >
      <div class="w-[19.6875rem] h-[19.6875rem] shrink-0 relative mobile-scroll-child 2sm:w-[24rem]">
