defmodule SkepticBot.Podcasts.DownloadingWorkerTest do
  ...
  describe "perform/1" do
    ...
    test "enqueues a transcribing job if downloading Eddie's podcasts is successful", %{id: id} do
      expect(MockDownloader, :download, fn _url, _video_path ->
        {:ok,
         "/var/folders/2w/T/012eb1cb-5b41-405f-bcab-7a5236eee471a909da70-13b7-4717-b1c0-c2d001521dc3.mp4"}
      end)
    ...
    @tag :capture_log
    test "does not enqueue a transcribing job if download process is unsuccessful", %{id: id} do
      expect(MockDownloader, :download, fn _url, _video_path ->
    ...
    @tag :capture_log
    test "does not enqueue a transcribing job if uploading process is unsuccessful", %{id: id} do
      expect(MockDownloader, :download, fn _url, _video_path ->
        {:ok,
         "/var/folders/2w/T/012eb1cb-5b41-405f-bcab-7a5236eee471a909da70-13b7-4717-b1c0-c2d001521dc3.mp4"}
      end)
