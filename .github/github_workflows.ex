    ...
    deploy_job("preview",
      ...
      steps: [
        ...
        [
          ...
          uses: "Deankinyua/fly-preview-apps@fix-secrets",
          env: fly_env(),
          with: [
            name: @preview_app_name,
            postgres_image: "almirsarajcic/fly-pgvector",
            secrets: ~s"""
            APPSIGNAL_APP_ENV=preview
            APPSIGNAL_PUSH_API_KEY=${{ secrets.APPSIGNAL_PUSH_API_KEY }}
            DATABASE_DUMP_FILE=${{ vars.DATABASE_DUMP_FILE }}
            FLY_API_TOKEN="${{ secrets.FLY_API_TOKEN }}"
            PHX_HOST=${{ env.PHX_HOST }}
            REPLICATE_API_TOKEN=${{ secrets.REPLICATE_API_TOKEN }}
            REPLICATE_WEBHOOK_SECRET=${{ secrets.REPLICATE_WEBHOOK_SECRET }}
            ...
            YOUTUBE_COOKIE_FILE=${{ secrets.YOUTUBE_COOKIE_FILE }}
            """
          ]
        ]
      ]
