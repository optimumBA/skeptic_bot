defmodule GithubWorkflows do
      ...
      steps: [
        ...
        [
          ...
          with: [
            ...
            secrets:
              "APPSIGNAL_APP_ENV=preview APPSIGNAL_PUSH_API_KEY=${{ secrets.APPSIGNAL_PUSH_API_KEY }} DATABASE_DUMP_FILE=${{ vars.DATABASE_DUMP_FILE }} FLY_API_TOKEN=${{ secrets.FLY_API_TOKEN }} PHX_HOST=${{ env.PHX_HOST }} REPLICATE_API_TOKEN=${{ secrets.REPLICATE_API_TOKEN }} REPLICATE_WEBHOOK_SECRET=${{ secrets.REPLICATE_WEBHOOK_SECRET }} SECRET_KEY_BASE=${{ secrets.SECRET_KEY_BASE }} TIGRIS_ACCESS_KEY_ID=${{ secrets.TIGRIS_ACCESS_KEY_ID }} TIGRIS_BUCKET=${{ vars.TIGRIS_BUCKET }} TIGRIS_SECRET_ACCESS_KEY=${{ secrets.TIGRIS_SECRET_ACCESS_KEY }} YOUTUBE_COOKIE_FILE=${{ secrets.YOUTUBE_COOKIE_FILE }}"
          ]
        ]
      ]
    )
  ...
  defp dummy_env_vars do
    [
      REPLICATE_API_TOKEN: "dummy_token",
      REPLICATE_WEBHOOK_SECRET: "dummy_webhook_secret",
      TIGRIS_ACCESS_KEY_ID: "dummy_access_key",
      TIGRIS_BUCKET: "dummy-bucket",
      TIGRIS_SECRET_ACCESS_KEY: "dummy_secret_key"
    ]
  end
end
